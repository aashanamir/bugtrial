    ...
    <div className={"pt-3 pb-3 mt-5"} style={{minHeight: "86vh"}}>
      {currentUser.email ? (
        <div className="card border-dark m-5">
          <h5 className="card-header text-white bg-danger text-white">User Dashboard</h5>
            ...
            <div className="row">
              ...
              <div className="col-md-9 col-sm-12">
                <div className="card border-dark">
                  <h5 className="card-header text-white bg-danger text-white">
                    {currentUser.displayName}
                  </h5>
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">
                      <span className="badge bg-danger text-white badge-pill">
                        User ID
                      </span>{" "}
                      {currentUser.id}
                    </li>
                    <li className="list-group-item">
                      <span className="badge bg-danger text-white badge-pill text-white">Name</span>{" "}
                      {currentUser.displayName}
                    </li>
                    <li className="list-group-item">
                      <span className="badge bg-danger text-white badge-pill">Email</span>{" "}
                      {currentUser.email}
                    </li>
                    <li className="list-group-item">
                      <span className="badge bg-danger text-white badge-pill">
        ...
        <h2 className={"text-center"}>
          Welcome to BTS. A bug tracking software. Please register or login
          to continue.
        </h2>
      )}
    </div>
