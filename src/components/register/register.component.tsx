...
const Register = () => {
  ...
  return (
    <div className={"text-center mb-5 mt-5"}>
      <form className="form-signin" onSubmit={handleSubmit} style={{width: "70%" , margin: "auto", marginTop:"90px"}}>
        <img
          className="mb-4"
      ...
      <Link to={"/bugtrail-v3/register-and-login"}>Already Have an account</Link>
    </div>
  );
};
